...
module.exports = function (webpackEnv) {
  ...
  const isEnvProduction = webpackEnv === "production" || webpackEnv.production;
  ...
  console.log("devtool sourcemap:", devtool);

  var devToolModuleFilenameTemplate = isEnvProduction
    ? (info) =>
        path
  ...
  console.log("devToolModuleFilenameTemplate:", devToolModuleFilenameTemplate);
